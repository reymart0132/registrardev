      ...
      public function paginationSearch($total_pages,$page,$search,$criteria){
        $adjacents = 3;
          ...
          if($lastpage > 1)
          {
            ...
            //previous button
            if ($page > 1)
              $pagination.= '<a style="background-color:white; border: 1px solid #DC65A1;color:#DC65A1; padding:3px; text-decoration: none;" href=\'viewAlumniAdminAdmin.php?search='.$search.'&submitAlumni=Submit&criteria='.$criteria.'&page='.$prev.'\'>&laquo; previous</a>';
            ...
            if ($lastpage < 7 + ($adjacents * 2))	//not enough pages to bother breaking it up
            {
              for ($counter = 1; $counter <= $lastpage; $counter++)
              {
                if ($counter == $page)
                  ...
                  $pagination.= '<a style="background-color:white; border: 1px solid #DC65A1; color:#DC65A1; padding:3px; text-decoration: none;" href=\'viewAlumniAdminAdmin.php?search='.$search.'&submitAlumni=Submit&criteria='.$criteria.'&page='.$counter.'\'>'.$counter.'</a>';
              }
            }
            elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
            {
              ...
              if($page < 1 + ($adjacents * 2))
              {
                for ($counter = 1; $counter < 4 + ($adjacents * 2); $counter++)
                {
                  if ($counter == $page)
                    ...
                    $pagination.= '<a style="background-color:white; border: 1px solid #DC65A1; color:#DC65A1; padding-left:13px;padding-right:13px;text-decoration: none; padding-top:2px;" href=\'viewAlumniAdminAdmin.php?search='.$search.'&&submitAlumni=Submitcriteria='.$criteria.'&page='.$counter.'\'>'.$counter.'</a>';
                }
                $pagination .= '<span style="padding-top:10px;"class=\'elipses\'>&nbsp; . . . &nbsp;</span>';
                $pagination.= '<a style="background-color:white; border: 1px solid #DC65A1; color:#DC65A1;padding-left:10px;padding-right:10px; text-decoration: none; padding-top:2px;"  href=\'viewAlumniAdminAdmin.php?search='.$search.'&submitAlumni=Submit&criteria='.$criteria.'&page='.$lastpage.'\'>'.$lastpage.'</a>';
              }
              //in middle; hide some front and some back
              elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
              {
                $pagination.= '<a style="background-color:white; border: 1px solid #DC65A1; padding-left:12px; color:#DC65A1;padding-right:12px;  text-decoration: none; padding-top:2px;" href=\'viewAlumniAdminAdmin.php?search='.$search.'&submitAlumni=Submit&criteria='.$criteria.'&page=1\'>1</a>';
                $pagination .= '<span style="padding-top:10px;" class=\'elipses\'>&nbsp; . . . &nbsp;</span>';
                for ($counter = $page - $adjacents; $counter <= $page + $adjacents; $counter++)
                {
                  if ($counter == $page)
                    ...
                    $pagination.= '<a style="background-color:white; border: 1px solid #DC65A1; color:#DC65A1; padding-left:10px;padding-right:10px;  text-decoration: none; padding-top:2px;"  href=\'viewAlumniAdminAdmin.php?search='.$search.'&criteria='.$criteria.'&submitAlumni=Submit&page='.$counter.'\'>'.$counter.'</a>';
                }
                $pagination .= '<span style = "padding-top:10px;"class=\'elipses\'>&nbsp; . . . &nbsp;</span>';
                $pagination.= '<a style="background-color:white; border: 1px solid #DC65A1; color:#DC65A1; padding-left:10px;padding-right:10px; text-decoration: none; padding-top:2px;"href=\'viewAlumniAdminAdmin.php?search='.$search.'&submitAlumni=Submit&criteria='.$criteria.'&page='.$lastpage.'\'>'.$lastpage.'</a>';
              }
              ...
              {
                $pagination.= '<a style="background-color:white; color:#DC65A1; border: 1px solid #DC65A1; color: #DC65A1; padding-left:13px;padding-right:13px; text-decoration: none; padding-top:2px;" href=\'viewAlumniAdminAdmin.php?search='.$search.'&submitAlumni=Submit&criteria='.$criteria.'&page=1.\'>1</a>';
                // $pagination.= '<a style="background-color:white; border: 1px solid #d1d1d1; padding-left:10px;padding-right:10px;  text-decoration: none; padding-top:2px;" href=\'viewAlumniAdminAdmin.php?page=2\'>2</a>';
                $pagination .= '<span style="padding-top:10px;" class=\'elipses\'> &nbsp; . . . . &nbsp;</span>';
                for ($counter = $lastpage - (2 + ($adjacents * 2)); $counter <= $lastpage; $counter++)
                {
                  if ($counter == $page)
                    ...
                    $pagination.= '<a style="background-color:white; color:#DC65A1; border: 1px solid #DC65A1; padding-left:10px;padding-right:10px;  text-decoration: none; padding-top:2px;" href=\'viewAlumniAdminAdmin.php?search='.$search.'&submitAlumni=Submit&criteria='.$criteria.'&page='.$counter.'\'>'.$counter.'</a>';
                }
              }
            }
            if ($page < $counter - 1)
              $pagination.= '<a style="background-color:white; border: 1px solid #DC65A1; color:#DC65A1;padding-right:15px; padding-left:15px; padding-top:3px;text-decoration: none;" href=\'viewAlumniAdminAdmin.php?search='.$search.'&submitAlumni=Submit&criteria='.$criteria.'&page='.$next.'\'>next &raquo;</a>';
            else
                 ...
                 if ($count>=1) {
                   foreach ($rows2 as $row) {
                      echo '<tr>';
                          ...
                          echo '<td clas  s="text-center" style="color:#DC65A1;">'.$view->getNationality($row->nationality).'</td>';
