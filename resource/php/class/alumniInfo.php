...
class alumniInfo{
    public $sno,$lname,$fname,$mname,$dc,$cno,$dob,$nt,$cs,$mg,$yg,$addr,$hno,$hfno,$eaddr,$octype,$emp,$baddr,$ofno,$emppos,$employer,$position;

    function __construct($sno=null,$lname=null,$fname=null,$mname=null,$dc=null,$nt=null,$cs=null,$yg=null,$eaddr=null,$employer=null,$position=null) {
