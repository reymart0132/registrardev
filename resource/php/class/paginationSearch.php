...
$adjacents = 3;
  ...
  if($lastpage >= 1)
  {
    ...
    //previous button
    if ($page > 1)
      $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&search=&submitAlumni=Submit&page='.$prev.'\'>&laquo; previous</a>';
    else
      $pagination.= '<span id="spanD" span class=\'disabled\'>&laquo previous</span>';
    //pages
    if ($lastpage < 7 + ($adjacents * 2))	//not enough pages to bother breaking it up
    {
      for ($counter = 1; $counter <= $lastpage; $counter++)
      {
        if ($counter == $page)
          ...
          $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&search=&submitAlumni=Submit&page='.$counter.'\'>'.$counter.'</a>';
      }
    }
    elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
    {
      ...
      if($page < 1 + ($adjacents * 2))
      {
        ...
        $pagination .= '<span  class=\'elipses\'>&nbsp; . . . &nbsp;</span>';
        $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&search=&submitAlumni=Submit&page='.$lastpage.'\'>'.$lastpage.'</a>';
      }
      //in middle; hide some front and some back
      elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
      {
        $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&search=&submitAlumni=Submit&page=1\'>1</a>';
        $pagination .= '<span class=\'elipses\'>&nbsp; . . . &nbsp;</span>';
        for ($counter = $page - $adjacents; $counter <= $page + $adjacents; $counter++)
        {
          if ($counter == $page)
      ...
      {
        $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&search=&submitAlumni=Submit&page=1.\'>1</a>';
        // $pagination.= '<a id="page" id"page" style="background-color:white; border: 1px solid #d1d1d1; padding-left:10px;padding-right:10px;  text-decoration: none; padding-top:2px;" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&search=&submitAlumni=Submit&page==2\'>2</a>';
        $pagination .= '<span class=\'elipses\'> &nbsp; . . . . &nbsp;</span>';
        for ($counter = $lastpage - (2 + ($adjacents * 2)); $counter <= $lastpage; $counter++)
        {
          if ($counter == $page)
    ...
    if ($page < $counter - 1)
      $pagination.= '<a id="pageN" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&search=&submitAlumni=Submit&page='.$next.'\'>next &raquo;</a>';
    else
      $pagination.=  '<span id="spanD" class=\'disabled\'>next &raquo;</span>';
    $pagination.= "</div>\n";
  }
...
public function paginationSearchA3($total_pages,$page,$search,$criteria,$dateTo,$dateFrom){
  $adjacents = 3;
    ...
    if($lastpage >= 1)
    {
      ...
      //previous button
      if ($page > 1)
        $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&criteria='.$criteria.'&search='.$graduate.'&submitAlumni=Submit&page='.$prev.'\'>&laquo; previous</a>';
      else
        $pagination.= '<span id="spanD" span class=\'disabled\'>&laquo previous</span>';
      //pages
      if ($lastpage < 7 + ($adjacents * 2))	//not enough pages to bother breaking it up
      {
        for ($counter = 1; $counter <= $lastpage; $counter++)
        {
          if ($counter == $page)
            ...
            $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&criteria='.$criteria.'&search='.$graduate.'&submitAlumni=Submit&page='.$counter.'\'>'.$counter.'</a>';
        }
      }
      elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
      {
        ...
        if($page < 1 + ($adjacents * 2))
        {
          ...
          $pagination .= '<span  class=\'elipses\'>&nbsp; . . . &nbsp;</span>';
          $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&criteria='.$criteria.'&search='.$graduate.'&submitAlumni=Submit&page='.$lastpage.'\'>'.$lastpage.'</a>';
        }
        //in middle; hide some front and some back
        elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
        {
          $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&criteria='.$criteria.'&search='.$graduate.'&submitAlumni=Submit&page=1\'>1</a>';
          $pagination .= '<span class=\'elipses\'>&nbsp; . . . &nbsp;</span>';
          for ($counter = $page - $adjacents; $counter <= $page + $adjacents; $counter++)
          {
            if ($counter == $page)
        ...
        {
          $pagination.= '<a id="page" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&criteria='.$criteria.'&search='.$graduate.'&submitAlumni=Submit&page=1.\'>1</a>';
          // $pagination.= '<a id="page" id"page" style="background-color:white; border: 1px solid #d1d1d1; padding-left:10px;padding-right:10px;  text-decoration: none; padding-top:2px;" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&criteria='.$criteria.'&search='.$graduate.'&submitAlumni=Submit&page==2\'>2</a>';
          $pagination .= '<span class=\'elipses\'> &nbsp; . . . . &nbsp;</span>';
          for ($counter = $lastpage - (2 + ($adjacents * 2)); $counter <= $lastpage; $counter++)
          {
            if ($counter == $page)
      ...
      if ($page < $counter - 1)
        $pagination.= '<a id="pageN" id"page" href=\'viewAlumni.php?dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&criteria='.$criteria.'&search='.$graduate.'&submitAlumni=Submit&page='.$next.'\'>next &raquo;</a>';
      else
        $pagination.=  '<span id="spanD" class=\'disabled\'>next &raquo;</span>';
      $pagination.= "</div>\n";
    }
