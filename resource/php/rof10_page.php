                        ...
                        <td>
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                  ...
                                  <input type="date" class="form-control" id="Firstname" name="DateGraduated" aria-describedby="emailHelp" placeholder="Enter Date" required>
                                </div>
                                <div class="form-group col-4">
                                  <label for=SpecialOrder"">Special Order(B) No.</label>
                                  <input type="number" class="form-control" id="Middlename" name="SpecialOrder" aria-describedby="emailHelp" placeholder="Enter Number" required>
                                </div>
                            </div>
                        </td>
                    </tr>
