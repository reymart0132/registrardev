                        ...
                        <td>
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                  ...
                                  <input type="text" class="form-control" id="Middlename" name="Middlename" aria-describedby="emailHelp" placeholder="Enter Middlename" value="<?php echo $mname ?>">
                                </div>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="form-group col-4">
                                  ...
                                  <input type="test" class="form-control" id="Lastname" name="DateToday" aria-describedby="emailHelp" placeholder="Enter Date" value="<?php echo date("d-m-Y"); ?>" required>
                                </div>
                                <div class="form-group col-4">
                                    <label for="Middlename">Course</label>
                                    <input type="text" class="form-control" id="course" name="course" aria-describedby="emailHelp" placeholder="Enter Course" value="<?php echo $course ?>"required>
                                  </div>
                                  <div class="form-group col-4">
