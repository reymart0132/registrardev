...
if(isset($_POST['submit'])){
  ...
  $add->addcourse();
  header("Location: add-new-course-titus.php");
}
?>
...
<body>
        ...
        <div class="container" style="">
          <div class="con text-center mt-5 pt-5">
            <h1 class="pb-3">Add a New Course</h1>
              <form method="POST" style="padding-left:300px; padding-right:300px;">
                   <div class="form-group">
                     <input type="text" class="form-control" id="request" name="course" placeholder="Enter Request" style="height:50px;" required>
                   </div>
                 <div class="form-group">
