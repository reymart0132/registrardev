    ...
    $adjacents = 3;
      ...
      if($lastpage > 1)
      {
        ...
        elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
        {
          ...
          {
            $pagination.= '<a style="background-color:white; border: 1px solid #DC65A1; padding-left:12px; color:#DC65A1;padding-right:12px;  text-decoration: none; padding-top:2px;" href=\'pending.php?tab=view&Ppage1\'>1</a>';
            $pagination .= '<span style="padding-top:10px;" class=\'elipses\'>&nbsp; . . . &nbsp;</span>';
          ...
          {
            $pagination.= '<a style="background-color:white; color:#DC65A1; border: 1px solid #DC65A1; color: #DC65A1; padding-left:13px;padding-right:13px; text-decoration: none; padding-top:2px;" href=\'pending.php?tab=view&Ppage1.\'>1</a>';
            // $pagination.= '<a style="background-color:white; border: 1px solid #d1d1d1; padding-left:10px;padding-right:10px;  text-decoration: none; padding-top:2px;" href=\'pending.php?tab=view&Ppage2\'>2</a>';
            $pagination .= '<span style="padding-top:10px;" class=\'elipses\'> &nbsp; . . . . &nbsp;</span>';
